...
class AuthenticationUserTestCase(APITestCase):
    ...
    def test_autenticacao_user_com_credenciais_corretas(self):
        ...
        user = authenticate(username='testeuser', password='123456')
    ...
    def test_autenticacao_de_user_com_username_incorreto(self):
        ...
        user = authenticate(username='testeuser', password='1234056')
    ...
    def test_autenticacao_de_user_com_password_incorreto(self):
        ...
        user = authenticate(username='testeuser', password='1234546')
        self.assertFalse((user is not None) and user.is_authenticated)
